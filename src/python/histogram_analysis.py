...
def refined_analysis_old(data, x_min, x_max, g1_guess, g2_guess, stdev=-1, target_range=100., output_filename=None):
	raw_values = data
	...
	return_dict['fit_data'] = [x_vals.tolist(), normal_curve(x_vals, g1_opt[1], 2*g1_opt[2], g1_opt[3]).tolist(), normal_curve(x_vals, g1_opt[0], g1_opt[2], g1_opt[3]).tolist(), s_phase(x_vals, g1_opt[2], g1_opt[3],g1_opt[4],g1_opt[5],g1_opt[6],g1_opt[7]).tolist(), np.histogram(raw_values, bins=x_vals, normed=True)[0].tolist()]
